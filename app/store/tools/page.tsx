...
export default function ToolsPage() {
  ...
  const generarExcelShalom = () => {
    ...
    const rows = selected.map(o => ({
      ...
      'TELF. CONTACTO': '',
      'NRO GRR': '',
      'ORIGEN': shalomOrigin.includes('/') ? shalomOrigin.split('/').pop()?.trim() || shalomOrigin : shalomOrigin,
      'DESTINO': (() => { const d = o.destination || ''; return d.includes('/') ? d.split('/').pop()?.trim() || d : d; })(),
